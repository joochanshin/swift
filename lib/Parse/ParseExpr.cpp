...
Parser::parseExprPostfixWithoutSuffix(Diag<> ID, bool isExprBasic) {
  ...
  case tok::pound_gradient:
    Result = parseExprGradientBody(ExprKind::Gradient);
    break;

  case tok::pound_valueAndGradient:
    Result = parseExprGradientBody(ExprKind::ValueAndGradient);
    break;

  case tok::pound_adjoint:
    Result = parseExprAdjoint();
    break;

  case tok::pound_assert:
    Result = parseExprPoundAssert();
    break;
