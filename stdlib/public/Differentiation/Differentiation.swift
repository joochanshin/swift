...
//===----------------------------------------------------------------------===//
//
// This file defines support for differentiable programming and may undergo
// changes. See forum discussion for more information:
...
public extension Differentiable {
  ...
  internal func _vjp_withRecomputationInPullbacks<Result : Differentiable>(
    ...
    return
      valueWithPullback(in: Differentiation.withRecomputationInPullbacks(body))
  }
}
...
public extension Array where Element: Differentiable {
  ...
  internal func _vjpDifferentiableReduce<Result: Differentiable>(
    ...
    for element in self {
      let (y, pb) = Differentiation.valueWithPullback(
        at: result, element, in: nextPartialResult
      )
      result = y
      pullbacks.append(pb)
    }
...
public extension Array where Element: Differentiable {
  ...
  internal func _vjpDifferentiableMap<Result: Differentiable>(
    ...
    for x in self {
      let (y, pb) = Differentiation.valueWithPullback(at: x, in: body)
      values.append(y)
      pullbacks.append(pb)
    }
