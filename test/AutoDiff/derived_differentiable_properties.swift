...
// CHECK-AST:   @differentiable(wrt: (a))
...
// CHECK-SILGEN-LABEL: // Foo.init(a:)
// CHECK-SILGEN-NEXT: sil hidden [differentiable source 0 wrt 0] @$s33derived_differentiable_properties3FooV1aACSf_tcfC : $@convention(method) (Float, @thin Foo.Type) -> Foo
...
// CHECK-AST:         @differentiable(wrt: (w))
