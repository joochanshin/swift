...
// CHECK-SIL-LABEL: sil [differentiable source 0 wrt 0, 1 vjp @$s3fooTUp0_1r0] [ossa] @foo
...
// CHECK-SIL-LABEL: sil [differentiable source 0 wrt 0, 1 vjp @$s13foo_indir_retTUp0_1r0] [ossa] @foo_indir_ret : $@convention(thin) <T where T : _Differentiable> (Float, @in_guaranteed T) -> @out T {
...
// CHECK-SIL-LABEL: sil [serialized] [differentiable source 0 wrt 0, 1 vjp @$s6hasvjpTUp0_1r0] [ossa] @hasvjp
...
// CHECK-SIL-NEXT: sil hidden [differentiable source 0 wrt 0 jvp @$s26differentiable_attr_silgen16DiffComputedPropV08computedF0SfvgTZp0r0 vjp @$s26differentiable_attr_silgen16DiffComputedPropV08computedF0SfvgTUp0r0] [ossa] @$s26differentiable_attr_silgen16DiffComputedPropV08computedF0Sfvg
