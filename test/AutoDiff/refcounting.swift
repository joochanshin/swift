...
// CHECK-NEXT: }
// CHECK-LABEL: struct {{.*}}testOwnedVector{{.*}}__PV__src_0_wrt_0 {
...
// CHECK: bb0([[SEED:%.*]] : $Vector, [[PRIMVALS:%.*]] : ${{.*}}UsesMethodOfNoDerivativeMember{{.*}}applied2to{{.*}}__PV__src_0_wrt_0_1):
// CHECK:   [[PB:%.*]] = struct_extract [[PRIMVALS]] : ${{.*}}UsesMethodOfNoDerivativeMember{{.*}}applied2to{{.*}}__PV__src_0_wrt_0_1
...
// CHECK: bb0([[SEED:%.*]] : $Vector, [[PRIMVALS:%.*]] : ${{.*}}subset_adjoint_releases_unused_ones{{.*}}__PV__src_0_wrt_0):
// CHECK:   [[PB0:%.*]] = struct_extract [[PRIMVALS]] : ${{.*}}subset_adjoint_releases_unused_ones{{.*}}, #{{.*}}subset_adjoint_releases_unused_ones{{.*}}__PV__src_0_wrt_0.pullback_1
...
// CHECK:   [[PB1:%.*]] = struct_extract [[PRIMVALS]] : ${{.*}}subset_adjoint_releases_unused_ones{{.*}}__PV__src_0_wrt_0, #{{.*}}subset_adjoint_releases_unused_ones{{.*}}__PV__src_0_wrt_0.pullback_0
...
// CHECK: bb0([[X:%.*]] : $Vector, %1 : ${{.*}}side_effect_release_zero{{.*}}_bb0__PV__src_0_wrt_0):
...
// CHECK: bb0({{%.*}} : $Vector, [[PULLBACKS_ARG:%.*]] : ${{.*}}testOwnedVector{{.*}}__PV__src_0_wrt_0):
// CHECK:   [[PULLBACK0:%.*]] = struct_extract [[PULLBACKS_ARG]] : ${{.*}}testOwnedVector{{.*}}__PV__src_0_wrt_0, #{{.*}}testOwnedVector{{.*}}__PV__src_0_wrt_0.pullback_0
